...
try {
    // Récupérer tous les rendez-vous, avec les informations de l'utilisateur
    ...
    // Gérer la suppression de rendez-vous par l'admin
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_appointment_id'])) {
        ...
        redirect('admin_appointments.php'); // Recharger pour afficher la mise à jour
    }
